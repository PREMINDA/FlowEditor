...
export function AlertModal({ message, onClose }: AlertModalProps) {
    return createPortal(
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/50 backdrop-blur-[1px] animate-in fade-in duration-200">
            <div className="bg-card w-[400px] max-w-[90vw] rounded-lg shadow-2xl border border-border overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="px-4 py-3 border-b border-border bg-muted/30 flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-foreground">Notice</h3>
                </div>
